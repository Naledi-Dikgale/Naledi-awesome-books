...
**Awesome-books-project** is a project to showcase my html,CSS and javascript skills applied in bulding a project
...
```sh
  cd my-folder
  git clone https://github.com/Naledi-Dikgale/awesome-books
```
